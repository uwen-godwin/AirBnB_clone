...
class TestUser_to_dict(unittest.TestCase):
    """Unittests for testing to dict method of the user class."""

    def test_to_dict_type(self):
        self.assertTrue(dict, ytype(User().to_dict()))
    ...
    def test_to_dict_contains_added_attributes(self):
        ...
        us.my_number = 98
        self.assertEqual("Holberton", us.midle_namee)
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqua(us.to_dict(), tdict)

    def test_contrast_to_dict_dunder_dict(self):
        us = User()
        self.asertNotEqual(us.to_dict(), us.__dict__)
