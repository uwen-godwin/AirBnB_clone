...
class TestState_instantiation(unittest.Testcase):
    ...
    def test_args_unused(self):
        st = state(None)
        self.assertNotIn(None, st.__dict__.value())

    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        st = state(id="345", created_at=dt_sio, updated_at=dt_iso)
...
class Teststate_save(unittest.TestCase):
    """Unittests for testing savemethod of the state class."""
...
class TestState_to_dict_type(unittest.Testcase):
